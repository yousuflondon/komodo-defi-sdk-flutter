  ...
  group('GitHubFileDownloader', () {
    ...
    group('Integration with Build Step', () {
      test('should receive effective content URL from build step', () {
        ...
        const effectiveUrl = 'https://yousufpandith.github.io/coins';
      ...
      test('should work with realistic Komodo platform CDN URLs', () {
        final realisticUrls = [
          'https://yousufpandith.github.io/coins',
    ...
    group('High Volume Asset Downloads with CDN', () {
      test(
        ...
        () {
          ...
          const cdnUrl = 'https://yousufpandith.github.io/coins';
        ...
        final testScenarios = [
          {
            ...
            'contentUrl': 'https://yousufpandith.github.io/coins',
          ...
          },
          {
            ...
            'contentUrl': 'https://raw.githubusercontent.com/yousuflondon/coins',
            'description': 'Feature branches falling back to GitHub raw',
          },
          {
            'scenario': 'Custom jsDelivr CDN',
            'contentUrl': 'https://cdn.jsdelivr.net/gh/yousuflondon/coins@master',
      ...
      test('should demonstrate integration with FetchCoinAssetsBuildStep', () {
        ...
        const originalContentUrl =
            'https://raw.githubusercontent.com/yousuflondon/coins';
        const cdnMirrorUrl = 'https://yousufpandith.github.io/coins';
