...
void main() {
  group('GithubCoinConfigProvider CDN mirrors', () {
    test('uses CDN base when exact branch mirror exists', () {
      ...
      expect(
        uri.toString(),
        'https://yousuflondon.github.io/coins/utils/coins_config_unfiltered.json',
      );
    });
    ...
    test('falls back to raw content when branch has no mirror', () {
      ...
      expect(
        uri.toString(),
        'https://raw.githubusercontent.com/yousuflondon/coins/dev/utils/coins_config_unfiltered.json',
      );
    });
    ...
    test('branchOrCommit override falls back to raw when not mirrored', () {
      ...
      expect(
        uri.toString(),
        'https://raw.githubusercontent.com/yousuflondon/coins/feature/example/utils/coins_config_unfiltered.json',
      );
    });
    ...
    test('uses raw URL for commit hash even when CDN is available', () {
      ...
      expect(
        uri.toString(),
        'https://raw.githubusercontent.com/yousuflondon/coins/f7d8e39cd11c3b6431df314fcaae5becc2814136/utils/coins_config_unfiltered.json',
      );
    });
    ...
    group('non-master/main branch behavior', () {
      ...
      test('feature branch uses GitHub raw URL even with CDN available', () {
        ...
        expect(
          uri.toString(),
          'https://raw.githubusercontent.com/yousuflondon/coins/feature/new-coin-support/utils/coins_config_unfiltered.json',
        );
      });
      ...
      test('release branch uses GitHub raw URL even with CDN available', () {
        ...
        expect(
          uri.toString(),
          'https://raw.githubusercontent.com/yousuflondon/coins/release/v1.2.0/utils/coins_config_unfiltered.json',
        );
      });
      ...
      test('hotfix branch uses GitHub raw URL even with CDN available', () {
        ...
        expect(
          uri.toString(),
          'https://raw.githubusercontent.com/yousuflondon/coins/hotfix/urgent-fix/utils/coins_config_unfiltered.json',
        );
      });
    });
    ...
    group('commit hash behavior', () {
      ...
      test('different commit hash uses GitHub raw URL', () {
        ...
        expect(
          uri.toString(),
          'https://raw.githubusercontent.com/yousuflondon/coins/abc123def456789012345678901234567890abcd/utils/coins_config_unfiltered.json',
        );
      });
    ...
    group('edge cases and validation', () {
      ...
      test('39-character string is treated as branch name', () {
        ...
        expect(
          uri.toString(),
          'https://raw.githubusercontent.com/yousuflondon/coins/f7d8e39cd11c3b6431df314fcaae5becc281413/utils/coins_config_unfiltered.json',
        );
      });
      ...
      test('41-character string is treated as branch name', () {
        ...
        expect(
          uri.toString(),
          'https://raw.githubusercontent.com/yousuflondon/coins/f7d8e39cd11c3b6431df314fcaae5becc2814136a/utils/coins_config_unfiltered.json',
        );
      });
      ...
      test('40-character string with non-hex characters is treated as branch', () {
        ...
        expect(
          uri.toString(),
          'https://raw.githubusercontent.com/yousuflondon/coins/f7d8e39cd11c3b6431df314fcaae5becc281413g/utils/coins_config_unfiltered.json',
        );
      });
    });
  });
  ...
  group('GithubCoinConfigProvider', () {
    ...
    test('reproduces commit hash appended to CDN URL bug', () async {
      ...
      // https://yousuflondon.github.io/coins/f7d8e39cd11c3b6431df314fcaae5becc2814136/utils/coins_config_unfiltered.json
      // But it should be:
      // https://raw.githubusercontent.com/yousuflondon/coins/f7d8e39cd11c3b6431df314fcaae5becc2814136/utils/coins_config_unfiltered.json
    ...
    test('buildContentUri normalizes coinsPath entries', () {
      ...
      expect(
        cdnUri.toString(),
        'https://yousuflondon.github.io/coins/coins/KMD.json',
      );
      ...
      expect(
        rawUri.toString(),
        'https://raw.githubusercontent.com/yousuflondon/coins/master/coins/KMD.json',
      );
    });
